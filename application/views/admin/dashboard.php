        ...
        ***********************************-->
        <div class="content-body">
			...
			<div class="container-fluid">
						...
						<div class="row">
								...
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											...
											<h2><?php if(!empty($users)){ echo count($users); }else{ echo '0'; } ?></h2>
										</div>	
							...
							<div class="col-xl-6 col-sm-6">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Pickup Location</span>
											<h2><?php if(!empty($pickup_location)){ echo count($pickup_location); }else{ echo '0'; } ?></h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
						...
						<div class="row">
								...
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											...
											<h2><?php if(!empty($total_order)){ echo count($total_order); }else{ echo '0'; } ?></h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
											<span class="donut1" data-peity='{ "fill": ["rgb(98, 79, 209,1)", "rgba(247, 245, 255)"],   "innerRadius": 35, "radius": 10}'>5/7</span>
											<small class="text-black">
							...
							<div class="col-xl-6 col-sm-6">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Total Orders Revenue</span>
											<h2><?php if(!empty($total_order_revenue)){ echo Round(($total_order_revenue['total_price']),2); }else{ echo '0'; } ?></h2>
										</div>	
											<div class="d-inline-block position-relative donut-chart-sale">
											<span class="donut1" data-peity='{ "fill": ["rgb(98, 79, 209,1)", "rgba(247, 245, 255)"],   "innerRadius": 35, "radius": 10}'>5/8</span>
											<small class="text-black">
						...
						<div class="row">
							...
							<div class="col-xl-6 col-sm-6">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Complete Order</span>
											<h2><?php if(!empty($complete_order)){ echo count($complete_order); }else{ echo '0'; } ?></h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
											<span class="donut1" data-peity='{ "fill": ["rgb(98, 79, 209,1)", "rgba(247, 245, 255)"],   "innerRadius": 35, "radius": 10}'>5/8</span>
											<small class="text-black">
							...
							<div class="col-xl-6 col-sm-6">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Complete Order Revenue</span>
											<h2><?php if(!empty($complete_order_revenue)){ echo Round(($complete_order_revenue['total_price']),2); }else{ echo '0'; } ?></h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
											<span class="donut1" data-peity='{ "fill": ["rgb(98, 79, 209,1)", "rgba(247, 245, 255)"],   "innerRadius": 35, "radius": 10}'>5/8</span>
											<small class="text-black">
						...
						<div class="row">
							...
							<div class="col-xl-6 col-sm-6">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Pending Order</span>
											<h2><?php if(!empty($pending_order)){ echo count($pending_order); }else{ echo '0'; } ?></h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
											<span class="donut1" data-peity='{ "fill": ["rgb(98, 79, 209,1)", "rgba(247, 245, 255)"],   "innerRadius": 35, "radius": 10}'>5/8</span>
											<small class="text-black">
							...
							<div class="col-xl-6 col-sm-6">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Pending Order Revenue</span>
											<h2><?php if(!empty($pending_order_revenue)){ echo Round(($pending_order_revenue['total_price']),2); }else{ echo '0'; } ?></h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
											<span class="donut1" data-peity='{ "fill": ["rgb(98, 79, 209,1)", "rgba(247, 245, 255)"],   "innerRadius": 35, "radius": 10}'>5/8</span>
											<small class="text-black">
				...
				<!-- <div class="mb-sm-4 d-flex flex-wrap align-items-center text-head">
					<h2 class="mb-3 me-auto">Earnings From Clients</h2>
					<div>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
							<li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
			...
			<!-- 	<div class="row">
						...
						<div class="row">
							<div class="col-xl-6 col-sm-6">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Total Daily Earning From Clients</span>
											<h2>$<?php if($earing_clients_daily && $earing_clients_daily['amount'] > 0){
												echo ($earing_clients_daily['amount']*$admin_tax['tax'])/100;
											}else{
												echo "0";
											} ?></h2>
										</div>	
							...
							<div class="col-xl-6 col-sm-6">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Total Weekly Earning From Clients</span>
											<h2>$<?php if($earing_clients_week && $earing_clients_week['amount'] > 0){
												echo ($earing_clients_week['amount']*$admin_tax['tax'])/100;
											}else{
												echo "0";
											} ?></h2>
										</div>	
								...
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Total Monthly Earning From Clients</span>
											<h2>$<?php if($earing_clients_month && $earing_clients_month['amount'] > 0){
												echo ($earing_clients_month['amount']*$admin_tax['tax'])/100;
											}else{
												echo "0";
											} ?></h2>
										</div>	
							...
							<div class="col-xl-6 col-sm-6">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Total Earning From Clients</span>
											<h2>$<?php if($earing_clients && $earing_clients['amount'] > 0){
												echo ($earing_clients['amount']*$admin_tax['tax'])/100;
											}else{
												echo "0";
											} ?></h2>
										</div>	
				...
				<!-- <div class="mb-sm-4 d-flex flex-wrap align-items-center text-head">
					<h2 class="mb-3 me-auto">Earnings From Workers</h2>
					<div>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
							<li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
						...
						<div class="row">
							<div class="col-xl-6 col-sm-6">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Total Daily Earning From Workers</span>
											<h2>$
											<?php if($earing_clients_daily && $earing_clients_daily['total_price'] > 0){
												echo $earing_clients_daily['total_price'];
											}else{
												echo "0";
											} ?>
										</h2>
							...
							<div class="col-xl-6 col-sm-6">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Total Weekly Earning From Workers</span>
											<h2>$
											<?php if($earing_clients_week && $earing_clients_week['total_price'] > 0){
												echo $earing_clients_week['total_price'];
											}else{
												echo "0";
											} ?>
										</h2>
							...
							<div class="col-xl-6 col-sm-6">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Total Monthly Earning From Workers</span>
											<h2>$
											<?php if($earing_clients_month && $earing_clients_month['total_price'] > 0){
												echo $earing_clients_month['total_price'];
											}else{
												echo "0";
											} ?>
										</h2>
							...
							<div class="col-xl-6 col-sm-6">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Total Earning From Workers</span>
											<h2>$
											<?php if($earing_clients && $earing_clients['total_price'] > 0){
												echo $earing_clients['total_price'];
											}else{
												echo "0";
											} ?>
										</h2>
