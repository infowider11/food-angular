							...
							<table id="example3" class="display" style="min-width: 845px">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<?php echo ($val['available']==1) ? '<span class="label label-primary">Enabled</span>' : '<span class="label label-danger">Disabled</span>'?>
										</td>
										<td>
					...
					<div class="row">
						<div class="mb-3 col-md-12">
							...
							<select class="form-control" name="category_id" required >
								...
								<?php foreach ($category as $key => $categoryV) { ?>
					...
					<div class="row">
						<div class="mb-3 col-md-12">
							...
							<select class="form-control" name="available" required >
								...
								<option value="1" <?= ($val['available']==1) ? "selected":""; ?> >Enabled</option>
								<option value="0" <?= ($val['available']==0) ? "selected":""; ?> >Disabled</option>
							</select>
						</div>
					</div>
